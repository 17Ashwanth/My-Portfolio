    ...
    <>
      <section id='home' className="d-flex justify-content-center align-items-center vh-100">
        <div className="text-center">
          ...
          <a href='https://drive.google.com/file/d/1VdtYYed4bPXu4k3RjJmOvbmAdqK9IVKc/view?usp=drive_link' target='_blank'><button  className='btn btn-primary mt-2'>GET THE RESUME{" "}<i class="fa-solid fa-download fa-bounce"></i></button></a>
        </div>
      </section>
    </>
  );
